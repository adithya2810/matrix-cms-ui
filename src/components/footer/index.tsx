          ...
          <div className="footer-section-col01-inner" style={{ width: 'unset', padding: '0 30px' }}>
            <div className="footer-col01-left-section">
              ...
              <span className="p-1 ml-4">
                <h6 className="sub-h2 font-medium text-lg leading-6 mr-12" style={{ lineHeight: '24px', letterSpacing: 1 }}>Sign up for the Matrix Moments series</h6>
                <input className="mt-2 text-secondary bg-accent p-2 pl-3 w-full" style={{ color: "#FBF9F5", backgroundColor: '#fbf9f514' }} type="email" placeholder="Your email address goes here" />
                <Button title="Subscribe" url="/icons/arrow.svg" className={"p-1 text-cta"} onClick={() => console.log("subscribe")} style={{ fontSize: 18, lineHeight: '24px', letterSpacing: 1 }} />
              </span>
            </div>
        ...
        <div className="page-center">
          <div className="footer-section-col02-inner laptop:flex laptop:items-center" style={{ padding: '0 30px' }}>
            ...
            <div className="privacyMenuWrap text-secondary flex items-center sm:mt-2 sm:grid sm:grid-cols-2 sm:gap-0  laptop:ml-20 ">
              <span className="caption p-1 w-28 text-sm sm:mt-2" style={{ letterSpacing: 1 }}>PRIVACY POLICY</span>
            </div>
          </div>
        </div>
      </div>
