...
const RoleDescription: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="col-span-1 pl-28 sm:pl-7 md:pl-0 md:pr-0 md:pt-11 sm:pt-5 sm:pr-5 sm:pb-5 lg:pl-16 pb-16">
        ...
        <h3 className="text-3xl leading-none font-extrabold text-black sm:uppercase sm:text-lg pt-8 sm:pt-5">JOB RESPONSIBILITIES</h3>
        <p className="text-3xl leading-snug font-normal text-black pt-3 sm:text-lg sm:pt-5">
          You're at the heart of your Manager’s operations and activities and the soul that keeps your Manager moving forward
        </p>
        <p className="text-3xl leading-snug font-normal text-black pt-8 sm:text-lg sm:pt-5">
        ...
        <h3 className="text-3xl leading-none font-bold text-black pt-16 sm:text-lg sm:pt-5 sm:uppercase">WHAT ARE WE LOOKING FOR</h3>
        <p className="text-3xl leading-snug font-normal text-black pt-6 sm:text-lg sm:pt-5">
          Years of Expericence : 3-14 Years
        </p>
        <h3 className="text-3xl leading-none font-bold text-accent pt-14 sm:text-lg sm:pt-5 sm:uppercase">Apply -{'>'}</h3>
      </div>
    </>
