...
function AdvisoryTeamPage(props) {
  return (<>
    <SocialMetaTags title="Advisory Team" image={`${process.env.NEXT_PUBLIC_APP_URL}/images/matrix-websitebanner-team1.jpg`} description="We are company builders first Our experience supports and amplifies companies over their lifespan" />
