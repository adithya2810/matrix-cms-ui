        ...
        <div className="content-center m-auto tabination" style={{ top: '-3.8rem' }}>
          <button onClick={() => setTabination('porfolioCompanies')}
            className={tabination === 'porfolioCompanies' ?
              "btn-active-bg text-white px-8 tab-btn sm:px-2 py-2 text-3md sm:text-sm md:text-2xl focus:outline-none"
              : "focus:outline-none text-white px-8 tab-btn sm:text-sm sm:px-2 py-2 text-3md md:text-2xl"}>
            Porfolio Companies
          </button>
