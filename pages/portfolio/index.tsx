...
function PortfolioPage<Props>({ portfolio, deviceType }) {
  return (<>
    <SocialMetaTags title="Portfolio" description="We work with visionary founders of early-stage startups to amplify their intrinsic talent." image={`${process.env.NEXT_PUBLIC_APP_URL}/images/matrix-websitebanner-portfolio1.jpg`} />
