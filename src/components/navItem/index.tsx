...
export const NavItem: React.FC<Props> = ({ title, selected, key, onClick , className=""}) => {
    return (
        <div className={`flex justify-between menu-primary-nav-text opacity-50 ${className}`} style={{ marginBottom: 25 }} onClick={() => onClick(key)}>
