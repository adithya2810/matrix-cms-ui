...
const PresskitForm: React.FC<propType> = ({ deviceType, pageType }) => {
  ...
  const submitForm = async event => {
    ...
    var mail_data = { to: 'salonie@matrixpartners.in,binita@matrixpartners.in,info@matrixpartners.in,komalsaini2010@gmail.com,jeet@topically.in', subject: 'New Presskit Enquery', html: '' };
    var html = '';
    for (var key in form) {
