      ...
      <div style={{ position: 'relative' }}>
        <div className="content-center m-auto tabination">
          <button onClick={() => setTabination('currentTeam')}
            className={tabination === 'currentTeam' ? "btn-active-bg text-white pt-19p pl-3p py-2 text-3xl" : "text-white pt-19p pl-3p py-2 text-3xl"}>
            INVESTMENTS
          </button>
          <button onClick={() => setTabination('pastTeam')}
            className={tabination === 'pastTeam' ? "btn-active-bg text-white pt-19p pl-3p py-2 text-3xl" : "text-white pt-19p pl-3p py-2 text-3xl"}>
            OPERATIONS
          </button>
        </div>
